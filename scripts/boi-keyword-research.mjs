...
async function main() {
  ...
  console.log('🔍 BOI Reporting Keyword Research\n');
  console.log('='.repeat(60));

  // Core keyword cluster for BOI Reporting
  const coreKeywords = [
    'boi reporting',
    'boi report',
  ...
  const questionQueries = [
    ...
    'boi reporting who is exempt',
    'boi reporting penalty how much',
    'finzen boi reporting 2026 update',
  ];
