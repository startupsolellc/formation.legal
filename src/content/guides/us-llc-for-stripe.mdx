...
heroImage:
  src: "/images/guides/stripe-three-address-layers.png"
  alt: "Three address layers diagram showing Registered Agent, Residential, and Business Operating addresses for Stripe verification"
  caption: "Understanding the three address layers is critical for US LLC + Stripe verification"
