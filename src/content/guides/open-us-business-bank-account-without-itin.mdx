...
heroImage: "open-us-business-bank-account-without-itin-2026-guide.jpg.png"
...
import decisionTree from '../../assets/images/guides/us-llc-banking-decision-tree-2026.png';
import approvalMatrix from '../../assets/images/guides/non-resident-bank-approval-matrix-2026.png';
import addressRejection from '../../assets/images/guides/us-bank-address-verification-rejection-example.png';
import costComparison from '../../assets/images/guides/hidden-costs-us-business-banking-comparison.png';
import documentsChecklist from '../../assets/images/guides/documents-required-open-us-bank-account-remotely.png';
...
<Image
  src={documentsChecklist}
  alt="Hero image showing the required documents for opening a US business bank account without ITIN: Passport, EIN, and functional website."
  width={1000}
  formats={['avif', 'webp']}
  class="rounded-lg"
/>
...
<Image
  src={decisionTree}
  alt="Flowchart showing how non-resident founders choose between Mercury, Relay, and Wise based on compliance requirements"
  width={1000}
  formats={['avif', 'webp']}
  class="rounded-lg"
/>
...
<Image
  src={approvalMatrix}
  alt="Comparison matrix of Mercury, Relay, Lili, and Slash highlighting prohibited countries and industry restrictions for LLC owners."
  width={1000}
  formats={['avif', 'webp']}
  class="rounded-lg"
/>
...
<Image
  src={addressRejection}
  alt="Visual explanation of how US banks use Google Street View to identify and reject registered agent or P.O. Box addresses."
  width={1000}
  formats={['avif', 'webp']}
  class="rounded-lg"
/>
...
<Image
  src={costComparison}
  alt="Bar chart illustrating the cumulative impact of FX markups and SWIFT fees on US business accounts over 3 years."
  width={1000}
  formats={['avif', 'webp']}
  class="rounded-lg"
/>
